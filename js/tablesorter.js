// Author: Christian Bach (http://tablesorter.com/docs/)
(function ($) {
    $.extend({
        tablesorter: new
    ...
    ts.addParser({
        ...
        format: function (s) {
            return $.tablesorter.formatFloat((s != "") ? new Date(s.replace(new RegExp(
                /-/g), "/")).getTime() : "0");
        },
        type: "numeric"
    });
    ...
    ts.addParser({
        ...
        format: function (s, table) {
            ...
            return $.tablesorter.formatFloat(new Date(s).
            getTime());
        },
        type: "numeric"
    });
